...
Si le nombre de passage en émission est supérieur ou égale à 15
Et que le temps d'émission est supérieur ou égale à 600 secondes (10 minutes)
...
campeur_tx = 15                 # nombre max de passage en émission
campeur_bf = 600                # nombre max de seconde en émission
